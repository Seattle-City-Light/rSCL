...
forecast_path <- "I:/FINANCE/FPU/Sales and Revenue Actuals Model/Update Database Scripts/Average Rates/2026 Average Rates Forecast.xlsx"
...
fpustats_write_average_rates_forecast(forecast_path = forecast_path,
                                      user = user,
                                      database = db)


check <- fpustats_read_average_rates_forecast(year=2025,
                                              most_eff_dt = T,
                                              user = user,
                                              database = db)
